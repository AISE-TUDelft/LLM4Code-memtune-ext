#!/usr/bin/env python3
"""
Sequential execution of memorization attack experiments.
Runs all quantization and epoch combinations in the correct order.

IMPORTANT NOTE: bf16_ep0.py should always the first one to be run because it creates the final .parquet file
"""
...
def main():
    ...
    print("🚀 Starting memorization attack experiment suite")
    ...
    print(f"Results saved in: attack_mem_plen.parquet")
