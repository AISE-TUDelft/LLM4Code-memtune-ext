...
fine_tuned_model = "AISE-TUDelft/StarCoder2Java-15b_ep2"
...
df_eval = pd.merge((pd.read_parquet('./attack_mem_ep.parquet')), df.to_pandas()[[gen_name]], left_index =True, right_index=True)
...
# Save the results
df_eval.to_parquet('./attack_mem_ep.parquet', index = False)
print("Results saved to attack_mem_ep.parquet")
print(f"----End attack----")