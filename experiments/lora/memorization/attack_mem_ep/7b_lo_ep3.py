...
fine_tuned_model = "aalkaswan/StarCoder2Java-7b_LoRA_ep3"
...
df_existing = pd.read_parquet('./attack_mem_ep.parquet')
df_eval = pd.merge(df_existing, df.to_pandas()[[gen_name]], left_index=True, right_index=True)
...
# Save the results
df_eval.to_parquet('./attack_mem_ep.parquet')
