#!/usr/bin/env python3
"""
Orchestrator script for LoRA memorization attack experiments across epochs.
...
def main():
    ...
    print("🚀 Starting LoRA Memorization Attack Experiments (attack_mem_ep)")
    ...
    for exp in completed_experiments:
        print(f"  ✅ {exp}")
    print(f"\nResults saved to: attack_mem_ep.parquet")
    print("You can now analyze the results using the generated parquet file.")
