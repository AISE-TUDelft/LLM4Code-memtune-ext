#!/usr/bin/env python3
"""
Sequential execution of memorization attack experiments across all epochs.
...
def main():
    ...
    scripts = [
        ...
        'me4b_ep1.py',   # Adds me4b_ep1 column
        'me4b_ep2.py',   # Adds me4b_ep2 column
        'me4b_ep3.py',   # Adds me4b_ep3 column
    ]

    print("🚀 Starting memorization attack experiment suite (all epochs)")
    print(f"Total scripts to run: {len(scripts)}")
    print(f"Started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("Experiment order: me4b (ep0→ep3)")
    ...
    print(f"Results saved in: attack_mem_ep.parquet")
    print("\nFinal dataset contains columns:")
    print("  - me4b_ep0, me4b_ep1, me4b_ep2, me4b_ep3")
