...
Runs all epoch combinations for deduplication attack experiments.

IMPORTANT NOTE: me4b_ep0.py MUST be run first as it creates the initial parquet files.
...
def main():
    ...
    scripts = [
        'me4b_ep0.py',   # Creates initial 4 parquet files (MUST BE FIRST)
        'me4b_ep3.py',   # Adds me4b_ep3 columns to all 4 files
    ]
    ...
    for i, script in enumerate(scripts, 1):
        ...
        if i == 1:
            print("⚠️  CRITICAL: Running me4b_ep0.py - this creates the base parquet files")
    ...
    print("    - me4b_ep0_d[X], me4b_ep3_d[X]")
